...
class Game(models.Model):
    """ othello_game：ゲーム情報
        ...
        gameStatus (models.IntegerFiled): 対局状況（"0=waiting", "1=ongame", "2=finished", "3=cancelled", or nulll）
    ...
    gameStatus = models.IntegerField(choices=CHOICES_STATUS, null=True)
...
class Log(models.Model):
    """ othello_log：棋譜
        ...
        player (models.IntegerField): 手番を行ったプレイヤー（"0=player1" or "1=player2"）
        ...
        board (models.CharField): 操作後の盤面情報（"E=なし", "W=白", or "b=黒"）
    ...
    player = models.IntegerField(choices=CHOICES_PLAYER)
